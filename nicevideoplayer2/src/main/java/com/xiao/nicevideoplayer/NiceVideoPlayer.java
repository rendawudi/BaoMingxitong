...
public class NiceVideoPlayer extends FrameLayout
    ...
    private int width;
    public final static int type_nomal=1;
    public final static int type_mini=2;
    public final static int type_full=3;
    public void setLast_state(int last_state){this.last_state=last_state;}
    public int getLast_state(){return last_state;}
...
//                    ((IjkMediaPlayer)mMediaPlayer).setOption(4, "framedrop", 1L);
    ...
    private void openMediaPlayer() {
        ...
        try {
            ...
            mController.setLenght(mMediaPlayer.getDuration());   //我的添加
            mController.onPlayStateChanged(mCurrentState);
    ...
    public boolean exitFullScreen() {
        last_state=type_nomal;
        System.out.println("推出全屏");
        last_state=type_full;
    ...
    public void enterTinyWindow() {
        last_state=type_mini;
        if (mCurrentMode == MODE_TINY_WINDOW) return;
        System.out.println("进入小屏幕");
        this.removeView(mContainer);
    ...
    public boolean tolaststate(int last_state){
        if(last_state==type_mini){
            enterTinyWindow();
        }
        return true;
    }
